...
4.  **Set up environment variables:**
    ...
    **Option A: Quick Start with Mock Data (Recommended for UI Development)**
    ...
    This allows you to start developing immediately without database setup. See [Mock Mode Guide](docs/MOCK_MODE.md) for details.

    **Option B: Full Setup with Real Database**
    ...
    You will need to set up a Supabase instance (or use the provided Docker setup) and get an API key from OpenRouter.
